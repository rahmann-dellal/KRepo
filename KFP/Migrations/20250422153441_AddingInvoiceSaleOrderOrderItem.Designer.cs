...
namespace KFP.Migrations
{
    ...
    [Migration("20250422153441_AddingInvoiceSaleOrderOrderItem")]
    partial class AddingInvoiceSaleOrderOrderItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KFP.DATA.OrderItem", b =>
                {
                    ...
                    b.HasOne("KFP.DATA.OrderItem", null)
                        .WithMany("AddOns")
                        .HasForeignKey("OrderItemId");

                    b.HasOne("KFP.DATA.OrderItem", "ParentOrderItem")
                        .WithMany("ChildrenOrderItems")
            ...
            modelBuilder.Entity("KFP.DATA.OrderItem", b =>
                {
                    ...
                    b.Navigation("ChildrenOrderItems");
                });
